...
# get the sources
RUN wget https://github.com/neutrinolabs/xrdp/releases/download/v${XRDP_VERSION}/xrdp-${XRDP_VERSION}.tar.gz
RUN tar xvzf xrdp-${XRDP_VERSION}.tar.gz
RUN mv xrdp-${XRDP_VERSION} "${XRDP_SRC_DIR}"  ; # renaming to make the other steps clearer
